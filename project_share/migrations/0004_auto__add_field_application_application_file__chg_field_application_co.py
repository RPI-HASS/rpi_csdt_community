...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.application_file'
        db.add_column(u'project_share_application', 'application_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Application.codebase_url'
        db.alter_column(u'project_share_application', 'codebase_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Application.url'
        db.alter_column(u'project_share_application', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Application.class_name'
        db.alter_column(u'project_share_application', 'class_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'Application.application_file'
        db.delete_column(u'project_share_application', 'application_file')


        # Changing field 'Application.codebase_url'
        db.alter_column(u'project_share_application', 'codebase_url', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Application.url'
        db.alter_column(u'project_share_application', 'url', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Application.class_name'
        db.alter_column(u'project_share_application', 'class_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255))
