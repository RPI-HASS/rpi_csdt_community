...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'project_share_fileupload', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('f', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'project_share', ['FileUpload'])


        # Changing field 'Project.screenshot'
        db.alter_column(u'project_share_project', 'screenshot', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Project.project'
        db.alter_column(u'project_share_project', 'project', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting model 'FileUpload'
        db.delete_table(u'project_share_fileupload')


        # Changing field 'Project.screenshot'
        db.alter_column(u'project_share_project', 'screenshot', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))

        # Changing field 'Project.project'
        db.alter_column(u'project_share_project', 'project', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100))
