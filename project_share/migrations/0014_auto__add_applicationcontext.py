...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApplicationContext'
        db.create_table(u'project_share_applicationcontext', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project_share.Application'])),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['project_share.ApplicationContext'], null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(default=100)),
            ('title', self.gf('django.db.models.fields.TextField')()),
            ('html_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'project_share', ['ApplicationContext'])


    def backwards(self, orm):
        # Deleting model 'ApplicationContext'
        db.delete_table(u'project_share_applicationcontext')
    ...
    models = {
        ...
        u'project_share.applicationcontext': {
            'Meta': {'object_name': 'ApplicationContext'},
            'application': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['project_share.Application']"}),
            'html_data': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.IntegerField', [], {'default': '100'}),
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['project_share.ApplicationContext']", 'null': 'True', 'blank': 'True'}),
