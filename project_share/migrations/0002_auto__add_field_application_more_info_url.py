...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.more_info_url'
        db.add_column(u'project_share_application', 'more_info_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.more_info_url'
        db.delete_column(u'project_share_application', 'more_info_url')
