...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'project_share_project', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='children', null=True, to=orm['project_share.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.parent'
        db.delete_column(u'project_share_project', 'parent_id')
