...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ApplicationDemo'
        db.create_table(u'project_share_applicationdemo', (
        ...
        db.send_create_signal(u'project_share', ['ApplicationDemo'])


    def backwards(self, orm):
        # Deleting model 'ApplicationDemo'
        db.delete_table(u'project_share_applicationdemo')
