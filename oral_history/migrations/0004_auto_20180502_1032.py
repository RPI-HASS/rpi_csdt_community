# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-05-02 14:32
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('oral_history', '0003_auto_20180501_1308'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='mp3_file',
            field=models.FileField(blank=True, null=True, upload_to='oralhistoryproject/%Y-%m-%d/', validators=[django.core.validators.FileExtensionValidator(['mp3'])]),
        ),
        migrations.AlterField(
            model_name='interview',
            name='pic',
